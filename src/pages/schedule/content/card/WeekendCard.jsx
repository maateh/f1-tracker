				...
				<div className="sprint-container">
					...
					<div className="datetime-container">
						...
						<span className="sprint-time">
							{weekend.sessions?.sprint[0].getFormattedDate('HH:mm')}
						</span>

						<FlashOnIcon />
						<span className="sprint-time">
							{weekend.sessions?.sprint[1].getFormattedDate('HH:mm')}
						</span>
					</div>
				</div>
			)}

			<Link className="results-info" to={`/results/${weekend.year}/rounds/${weekend.round}/race`}>
				Weekend results
			</Link>
